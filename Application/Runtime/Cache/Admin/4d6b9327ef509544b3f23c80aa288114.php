...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td><input type="text" name="design_title" value="<?php echo ($dl["design_title"]); ?>"/></td>
    </tr>
    <tr>
        <td class="tableleft">描述</td>
        <td><textarea cols="40" rows="5" name="design_desc" id="design_desc" style="width:380px;"> <?php echo ($dl["design_title"]); ?> </textarea></td>
    </tr>
    <tr>
