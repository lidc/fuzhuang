...
<form name="userLoginActionForm" id="userLoginActionForm" method="POST" action="/fuzhuang/index.php/Admin/Index/login" target="_parent" >
    ...
    <input type="text" id="validatecode" name="validatecode" value="" placeholder="验证码" style="border:1px #CCCCCC solid"maxlength="20" />    
...
=======
    	<li>一、1月28日手机版、微信网站上线  &nbsp;  -- <?php echo ($vo["nav_title"]); ?></li>
