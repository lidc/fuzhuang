...
<form class="form-inline definewidth m20" action="index" method="get">  
    设计名称：
    <input type="text" name="design_title" id="design_title"class="abc input-default" placeholder="" value="<?php echo ($design_title); ?>">&nbsp;&nbsp;  
   类型：
...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
	           ...
	           <td>
	                 <a href="/fuzhuang/index.php/Admin/Design/edit?id=<?php echo ($v["id"]); ?>">编辑</a>    
	                 <a href="/fuzhuang/index.php/Admin/Design/delete?id=<?php echo ($v["id"]); ?>">删除</a>              
	           </td>
