...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td><textarea cols="40" rows="5" name="news_desc" id="news_desc" style="width:380px;"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="hotOffers" value="1" /> 首页图片推荐
    ...
    <tr>
        ...
        <td>
        	<textarea cols="40" rows="5" name="news_content" id="news_content"></textarea>
        </td>
    </tr>
    <tr>
