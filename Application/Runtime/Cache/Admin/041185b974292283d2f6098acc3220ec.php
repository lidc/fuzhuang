...
<form name="userLoginActionForm" id="userLoginActionForm" method="POST" action="/fuzhuang/index.php/Admin/Index/login" target="_parent" >
	<input type="text" id="username" name="username" value="" maxlength="20" placeholder="请输入用户名……"  onkeydown="onkeydowns(this.form);" />
    <input type="password" id="userpwd" name="userpwd" maxlength="20" placeholder="请输入用户密码……" onkeydown="onkeydowns(this.form);" />
    <input type="text" id="validatecode" name="validatecode" value="" placeholder="验证码" onkeydown="onkeydowns(this.form);" style="border:1px #CCCCCC solid"maxlength="20" />    
