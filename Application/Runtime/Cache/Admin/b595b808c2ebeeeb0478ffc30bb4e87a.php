...
<div class="content">
  <div class="dl-main-nav">
    ...
    <ul id="J_Nav"  class="nav-list ks-clear">
      ...
      <li class="nav-item dl-selected">
        <div class="nav-item-inner nav-order">品牌资讯</div>
      </li>
...
<script>
    ...
    //     });
    // });    ,{id:'11',text:'产品品牌',href:'<?php echo ($__FILE__); ?>Admin/Brand/index'}
  BUI.use('common/main',function(){
        var config = [{id:'1',homePage : '2',menu:[{text:'系统管理',items:[{id:'2',text:'系统信息',href:'<?php echo ($__FILE__); ?>Admin/System/index'},{id:'3',text:'用户管理',href:'<?php echo ($__FILE__); ?>Admin/User/index'},{id:'4',text:'菜单管理',href:'<?php echo ($__FILE__); ?>Admin/Node/index'},{id:'5',text:'Banner管理',href:'<?php echo ($__FILE__); ?>Admin/Banner/index'}]}]},{id:'7', homePage : '9', menu:[{text:'产品管理',items:[{id:'9',text:'产品列表',href:'<?php echo ($__FILE__); ?>Admin/Product/index'},{id:'10',text:'产品类别',href:'<?php echo ($__FILE__); ?>Admin/ProductCategory/index'}]}]},{id:'13',homePage : '14',menu:[{text:'创意设计', items:[{id:'14',text:'设计类资讯',href:'<?php echo ($__FILE__); ?>Admin/Design/index'},{id:'15',text:'设计分类',href:'<?php echo ($__FILE__); ?>Admin/DesignCategory/index'}]}]},{id:'17', homePage : '18',menu:[{text:'新闻资讯', items:[{id:'18',text:'新闻列表',href:'<?php echo ($__FILE__); ?>Admin/News/index'},{id:'19',text:'新闻分类',href:'<?php echo ($__FILE__); ?>Admin/NewsCategory/index'}]}]},{id:'21', homePage : '22',menu:[{text:'品牌资讯', items:[{id:'22',text:'品牌咨询',href:'<?php echo ($__FILE__); ?>Admin/Brand/index'}]}]}];
        new PageUtil.MainPage({
            modulesConfig : config
        });
    }); 
