...
<body>
<form action="add" method="post" class="definewidth m20" enctype="multipart/form-data">
<table class="table table-bordered table-hover m10">
    <tr>
        ...
        <td>
            <select name="parentid">
            	...
            	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value='<?php echo ($v['id']); ?>'/>&nbsp;<?php echo ($v['nav_title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>            	            
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><textarea cols="40" rows="5" name="nav_desc" id="nav_desc" style="width:380px;"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="nav_status" value="1" checked/> 启用
            <input type="radio" name="nav_status" value="0"/> 禁用
        </td>
    </tr>
    <tr>
