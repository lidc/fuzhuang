...
class KindEditor{
    ...
    private $loadKindEditor_css_js = '';
    
    function __construct(){
        $loadcss = '<link rel="stylesheet" href="'.__ROOT__.'/plug-in/kindeditor/themes/default/default.css"/>';
        $loadjs = '<script type="text/javascript" src="'.__ROOT__.'/plug-in/kindeditor/kindeditor.js"></script>';
        $loadjs .= '<script type="text/javascript" src="'.__ROOT__.'/plug-in/kindeditor/lang/zh_CN.js"></script>';
        $this->loadKindEditor_css_js = $loadcss.$loadjs;
    }
    ...
    public function get_include_css_js(){
        $css_js = '<link rel="stylesheet" href="'.__ROOT__.'/plug-in/kindeditor/themes/default/default.css"/>';
        return '';
    }
    ...
    public function create_editor($textarea_name,$width=null,$height=null,$mode=null,$after_change_fun=null){        
        $editor_code = $this->loadKindEditor_css_js;
        $width_height = '';
        ...
        $editor_code .= "<script>
			...
			editor_obj_".$textarea_name." = KindEditor.create('textarea[name=\"" . $textarea_name . "\"]', {
				uploadJson : '" . __ROOT__ . "/plug-in/kindeditor/php/upload_json.php',"
